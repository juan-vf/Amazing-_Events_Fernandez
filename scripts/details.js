...
console.log(events);
function filterCardById(array, id){
    let arrayFiltrado = array.filter(element => element._id == id);
    return arrayFiltrado;
}
function renderDetailCard(arrayCard){
    let event = arrayCard[0];
    console.log(event);
    let html = '';
    html += `
...
renderDetailCard(filterCardById(events, id))